...
<div class="tab-pane fade <?php echo (isset($_GET['tab']) && $_GET['tab'] === 'settings') ? 'show active' : ''; ?>"
	...
	<div class="container">
		<div class="settings section">
			<?php
			$selected_mode = get_option(LogModel::LOG_UPDATES_MODE_OPTION_NAME);
			if (empty($selected_mode)) {
				$selected_mode = 'MANUAL';
			}

			$selected_datetime_format = get_option(LogModel::DATETIME_FORMAT_OPTION_NAME);
			if (empty($selected_datetime_format)) {
				$selected_datetime_format = 'ABSOLUTE';
			}
			?>
					...
					<div class="form-check">
						<label class="form-check-label">
							<input class="form-check-input"
								...
								<?php checked($selected_datetime_format, 'ABSOLUTE'); ?>
								type="radio"
					...
					<div class="form-check">
						<label class="form-check-label">
							<input class="form-check-input"
								...
								<?php checked($selected_datetime_format, 'RELATIVE'); ?>
								type="radio"
								name="DatetimeFormatRadioOptions"
