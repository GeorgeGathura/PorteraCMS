                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="form-group comments">
                                        <textarea class="form-control" id="comments" name="comments" placeholder="Ask us anything"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                ...
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label" for="terms">
                                        <input type="checkbox" class="form-check-input terms-input" id="terms" name="consent" required/>

                                        By submitting this form, you agree that Portera will collect, process, and use any information provided by you as described in our <a href="#">Privacy Policy</a>.
                                    </label>
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <button class="btn btn-dark effect btn-sm" type="submit" name="submit" id="submit">
